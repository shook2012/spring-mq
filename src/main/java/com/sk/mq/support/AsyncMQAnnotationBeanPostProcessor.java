...
import com.sk.mq.core.RocketMQMessageListener;
...
public class AsyncMQAnnotationBeanPostProcessor
    ...
    private String resolveTopic(String  topicExpr) {
        String topicPrefix = resolveExpression(ROCKETMQ_TOPIC_PREFIX_KEY);
        if(topicPrefix.equals(ROCKETMQ_TOPIC_PREFIX_KEY)){
            topicPrefix = "";
        }
